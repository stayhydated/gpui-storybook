...
const PROJECT: Project = Project::new(
    "gpui-storybook",
    "Storybook for GPUI with sidebar-contained, pane-centered previews, responsive resizing, live controls, theme editing, Inspector integration, ordered in-process interaction automation, and reproducible story-region capture.",
)
