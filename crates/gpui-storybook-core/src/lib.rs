...
//! window creation, the searchable gallery layout, story container panel
//! behavior, title-bar composition, local preference resolution and
//! persistence, embedded localization/assets, and shared registry entry types.
//!
...
//!   optional default automation global consumed by the base gallery
//!   constructor. The gallery uses one frame-aware executor and one exclusive
//!   mutation/capture guard.
